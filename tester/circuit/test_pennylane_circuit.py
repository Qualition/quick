...
class TestPennylaneCircuit(TestCircuit):
    ...
    def test_circuit_initialization(self) -> None:
        """ Test the initialization of the `PennylaneCircuit` class.
        """
        pass
    ...
    def test_X(self) -> None:
        ...
        # Compare the results
        assert np.all(circuit.get_unitary() == np.array(qml.matrix(pennylane_circuit)(), dtype=complex))
