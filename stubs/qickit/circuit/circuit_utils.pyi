...
def dec_uc_rotations(angles: NDArray[np.float64], start_index: int, end_index: int, reversed_dec: bool) -> None: ...
...
def dec_ucg_help(sq_gates: list[NDArray[np.complex128]], num_qubits: int) -> tuple[list[NDArray[np.complex128]], NDArray[np.complex128]]: ...
