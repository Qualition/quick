...
class Circuit(ABC, metaclass=abc.ABCMeta):
    ...
    def UCRX(self, control_indices: int | Sequence[int], target_index: int, angles: Sequence[float]) -> None: ...
    def UCRY(self, control_indices: int | Sequence[int], target_index: int, angles: Sequence[float]) -> None: ...
    def UCRZ(self, control_indices: int | Sequence[int], target_index: int, angles: Sequence[float]) -> None: ...
