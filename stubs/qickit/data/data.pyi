...
class Data:
    ...
    @staticmethod
    def normalize_data(data: NDArray[np.number], norm_scale: np.float64, data_shape: tuple[int, ...]) -> NDArray[np.number]: ...
    def normalize(self) -> None: ...
    @staticmethod
    def denormalize_data(data: NDArray[np.number], norm_scale: np.float64, data_shape: tuple[int, ...]) -> NDArray[np.number]: ...
    ...
    def draw(self) -> None: ...
    @staticmethod
    def iscloseto(first_data: object, second_data: object, tolerance: float = 0.01) -> bool: ...
