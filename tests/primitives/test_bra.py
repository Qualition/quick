...
class TestBra:
    """ `tests.primitives.test_bra.TestBra` is the tester class for `quick.primitives.Bra`.
    """
    def test_init(self) -> None:
        """ Test the initialization of the `quick.primitives.Bra` class.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
        assert_allclose(bra.data, np.array([1+0j, 0+0j, 0+0j, 0+0j]))

    def test_from_scalar_fail(self) -> None:
        """ Test the failure of defining a `quick.primitives.Bra` object from a scalar.
        """
        with pytest.raises(AttributeError):
            Bra(1) # type: ignore

    def test_from_operator_fail(self) -> None:
        """ Test the failure of defining a `quick.primitives.Bra` object from an operator.
        """
        with pytest.raises(ValueError):
            Bra(np.eye(4, dtype=complex))

    def test_check_normalization(self) -> None:
        """ Test the normalization of the `quick.primitives.Bra` object.
        """
        data = np.array([1, 0, 0, 0])
        assert Bra.check_normalization(data)

    def test_check_normalization_fail(self) -> None:
        """ Test the failure of the normalization of the `quick.primitives.Bra` object.
        """
    ...
    def test_check_padding(self) -> None:
        """ Test the padding of the `quick.primitives.Bra` object.
        """
        data = np.array([1, 0, 0, 0])
        assert Bra.check_padding(data)

    def test_check_padding_fail(self) -> None:
        """ Test the failure of the padding of the `quick.primitives.Bra` object.
        """
        data = np.array([1, 0, 0])
    ...
    def test_to_ket(self) -> None:
        """ Test the conversion of the `quick.primitives.Bra` object to a `quick.primitives.Ket` object.
        """
    ...
    def test_change_indexing(self) -> None:
        """ Test the change of indexing of the `quick.primitives.Bra` object.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
    ...
    def test_change_indexing_fail(self) -> None:
        """ Test the failure of the change of indexing of the `quick.primitives.Bra` object.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
        with pytest.raises(ValueError):
    ...
    def test_check_mul(self) -> None:
        """ Test the multiplication of the `quick.primitives.Bra` object.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
        bra._check__mul__(1)
    ...
    def test_check_mul_fail(self) -> None:
        """ Test the failure of the multiplication of the `quick.primitives.Bra` object.
        """
        ket = Ket(np.array([1, 0, 0, 0]))
    ...
    def test_eq(self) -> None:
        """ Test the equality of the `quick.primitives.Bra` object.
        """
    ...
    def test_eq_fail(self) -> None:
        """ Test the failure of the equality of the `quick.primitives.Bra` object.
        """
        bra1 = Bra(np.array([1, 0, 0, 0]))
    ...
    def test_len(self) -> None:
        """ Test the length of the `quick.primitives.Bra` object.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
        assert len(bra) == 4

    def test_add(self) -> None:
        """ Test the addition of the `quick.primitives.Bra` objects.
        """
        bra1 = Bra(np.array([1, 0, 0, 0]))
        bra2 = Bra(np.array([0, 1, 0, 0]))
    ...
    def test_add_fail(self) -> None:
        """ Test the failure of the addition of the `quick.primitives.Bra` objects.
        """
        bra1 = Bra(np.array([1, 0, 0, 0]))
    ...
    def test_mul_scalar(self) -> None:
        """ Test the multiplication of the `quick.primitives.Bra` object with a scalar.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
        assert_allclose((bra * 2).data, np.array([1+0j, 0+0j, 0+0j, 0+0j]))

    def test_mul_bra(self) -> None:
        """ Test the multiplication of the `quick.primitives.Bra` object with a `quick.primitives.Ket` object.
        """
        ket = Ket(np.array([1, 0, 0, 0]))
        bra = Bra(np.array([1, 0, 0, 0]))
    ...
    def test_rmul_scalar(self) -> None:
        """ Test the multiplication of a `quick.primitives.Bra` object with a scalar.
        """
        bra = Bra(np.array([1, 0, 0, 0]))
