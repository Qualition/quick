...
def test_two_qubit_decomposition_up_to_diagonal() -> None:
...
def test_decomp2_supercontrolled() -> None:
...
def test_decomp3_supercontrolled() -> None:
    ...
    circuit.circuit_log = [
        {'gate': 'U3', 'angles': [1.4795141072922737, 4.022999026161385, -1.4643238780690337], 'qubit_index': 0},
        {'gate': 'U3', 'angles': [0.99368034324659, -0.4046788743527383, 5.325053604136903], 'qubit_index': 1},
        {'gate': 'CX', 'control_index': 0, 'target_index': 1},
        {'gate': 'U3', 'angles': [0.8960711613534293, 0.0, -3.141592653589793], 'qubit_index': 0},
        {'gate': 'U3', 'angles': [0.26210799778546756, 1.5707963267948966, 3.141592653589793], 'qubit_index': 1},
        {'gate': 'CX', 'control_index': 0, 'target_index': 1},
        {'gate': 'U3', 'angles': [0.147522578941486, -4.71238898038469, 0.0], 'qubit_index': 0},
        {'gate': 'U3', 'angles': [1.5707963267948966, -1.5707963267948966, -3.141592653589793], 'qubit_index': 1},
        {'gate': 'CX', 'control_index': 0, 'target_index': 1},
        {'gate': 'U3', 'angles': [1.4795141073495195, -1.4643238779322805, 4.022999026024632], 'qubit_index': 0},
        {'gate': 'U3', 'angles': [1.2101762902010682, -2.7812036037162535, -0.7484456350052462], 'qubit_index': 1},
...
def test_invalid_unitary_fail() -> None:
