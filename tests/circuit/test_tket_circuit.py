...
class TestTKETCircuit(Template):
    """ `tests.circuit.TestTKETCircuit` is the tester class for `quick.circuit.TKETCircuit` class.
    """
    ...
    def test_Identity(
        ...
        # Define the `quick.circuit.TKETCircuit` instance
    ...
    def test_get_unitary(self) -> None:
        ...
        # Define the equivalent `quick.circuit.TKETCircuit` instance, and
        # ensure they are equivalent
