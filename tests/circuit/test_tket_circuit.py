...
class TestTKETCircuit(Template):
    ...
    def test_Sdg(self) -> None:
        ...
        # Apply the Clifford-Sdg gate
        circuit.Sdg(0)

        assert_almost_equal(circuit.get_unitary(), np.conj(S_unitary_matrix), 8)
    ...
    def test_Tdg(self) -> None:
        ...
        # Apply the Clifford-Tdg gate
        circuit.Tdg(0)

        assert_almost_equal(circuit.get_unitary(), np.conj(T_unitary_matrix), 8)
    ...
    def test_CSdg(self) -> None:
        ...
        assert_almost_equal(circuit.get_unitary(), np.conj(CS_unitary_matrix), 8)
    ...
    def test_CTdg(self) -> None:
        ...
        assert_almost_equal(circuit.get_unitary(), np.conj(CT_unitary_matrix), 8)
    ...
    def test_MCSdg(self) -> None:
        ...
        assert_almost_equal(circuit.get_unitary(), np.conj(MCS_unitary_matrix), 8)
    ...
    def test_MCTdg(self) -> None:
        ...
        assert_almost_equal(circuit.get_unitary(), np.conj(MCT_unitary_matrix), 8)
    ...
    def test_remove_measurement(self) -> None:
        # Define the `qickit.circuit.TKETCircuit` instance
        circuit = TKETCircuit(2)
        no_measurement_circuit = TKETCircuit(2)
