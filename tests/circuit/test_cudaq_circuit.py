...
# from qickit.circuit import CUDAQCircuit
...
# class TestCUDAQCircuit(Template):
#     """ `tests.circuit.TestCUDAQCircuit` is the tester class for `qickit.circuit.CUDAQCircuit` class.
#     """
#     def test_init(self) -> None:
#         # Define the `qickit.circuit.CUDAQCircuit` instance
#         circuit = CUDAQCircuit(1)

#     def test_num_qubits_value(self) -> None:
#         # Ensure the error is raised when the number of qubits is less than or equal to 0
#         with pytest.raises(ValueError):
#             circuit = CUDAQCircuit(0)
...
#         # Define the checker
#         checker_circuit = CUDAQCircuit(3)
...
#         # # Define `qickit.circuit.CUDAQCircuit` instance
#         # circuit = CUDAQCircuit(1)
...
#         circuit = CUDAQCircuit(2)
#         no_measurement_circuit = CUDAQCircuit(2)
...
#         # Define the equivalent `qickit.circuit.CUDAQCircuit` instance, and
#         # ensure they are equivalent
...
#         # Define the equivalent `qickit.circuit.CUDAQCircuit` instance, and
#         # ensure they are equivalent
#         unitary_circuit = CUDAQCircuit(4)
...
#         # Define the equivalent `qickit.circuit.CUDAQCircuit` instance, and
#         # ensure they are equivalent
#         updated_circuit = CUDAQCircuit(2)
#         updated_circuit.H(1)
...
#         # Define the `qickit.circuit.CUDAQCircuit` instances
#         circuit1 = CUDAQCircuit(2)
#         circuit2 = CUDAQCircuit(2)
...
#         # Define the equivalent `qickit.circuit.CUDAQCircuit` instance, and
#         # ensure they are equivalent
#         transpiled_circuit = CUDAQCircuit(4)
...
#         # Define the equivalent `qickit.circuit.CUDAQCircuit` instance, and
#         # ensure they are equivalent
#         compressed_circuit = CUDAQCircuit(1)
