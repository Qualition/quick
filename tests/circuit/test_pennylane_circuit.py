...
class TestPennylaneCircuit(Template):
    ...
    def test_single_qubit_gate_from_range(self) -> None:
        ...
        # Define the checker
        checker_circuit = PennylaneCircuit(3)
    ...
    def test_Identity(self) -> None:
        ...
        # Ensure the Identity gate is correct
    ...
    def test_horizontal_reverse(self) -> None:
        ...
        # Define the equivalent `qickit.circuit.PennylaneCircuit` instance, and
        # ensure they are equivalent
        updated_circuit = PennylaneCircuit(4)
