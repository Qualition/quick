...
class TestDecompose:
    ...
    def test_MCX(
        ...
        # Check the decomposed circuit
        # We use 0.3926990817352963 to account for floating point errors after 10th decimal
        checker_circuit = framework(4)
        checker_circuit.U3([np.pi/2, 0, np.pi], [2, 3])
        checker_circuit.CX(0, 2)
        checker_circuit.U3([0.0, -0.3926990817352963, -0.3926990817352963], 2)
        checker_circuit.GlobalPhase(0.3926990817352963)
        ...
        checker_circuit.U3([0, -0.3926990817352963, -0.3926990817352963], 3)
        checker_circuit.GlobalPhase(0.3926990817352963)
