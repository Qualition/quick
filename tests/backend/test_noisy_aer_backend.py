...
from qickit.backend import NoisyAerBackend
...
class TestNoisyAerBackend(Template):
    """ `TestNoisyAerBackend` is the tester for the `NoisyAerBackend` class.
    """
    def test_init(self) -> None:
        """ Test the initialization of the backend.
        """
        # Define the `qickit.backend.NoisyAerBackend` instance
        backend = NoisyAerBackend(0.01, 0.02)
